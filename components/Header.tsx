...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="bg-sky-500 text-white py-2 hidden lg:block border-b border-sky-600">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center text-xs">
            <div className="flex items-center space-x-6">
              <a href="tel:+919911380288" className="flex items-center gap-2 hover:text-yellow-300 transition-colors duration-200 group">
                <Phone size={14} className="text-green-400 group-hover:text-yellow-300" />
                <span className="font-semibold">+91 9911-380288</span>
              </a>
              <a href="tel:+919811582086" className="flex items-center gap-2 hover:text-yellow-300 transition-colors duration-200 group">
                <Phone size={14} className="text-green-400 group-hover:text-yellow-300" />
                <span className="font-semibold">+91 9811-582086</span>
              </a>
              <a href="tel:01145725538" className="flex items-center gap-2 hover:text-yellow-300 transition-colors duration-200 group">
                <Phone size={14} className="text-green-400 group-hover:text-yellow-300" />
                <span className="font-semibold">011 4572 5538</span>
              </a>
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Mon-Sat: 7 AM – 8 PM | Sun: 8 AM – 2 PM</span>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              ...
              <Link href="/book-test" className="bg-white text-sky-600 px-4 py-1.5 rounded-full hover:bg-sky-50 transition-all duration-200 font-bold shadow-md hover:shadow-lg">
                Book Test
              </Link>
            </div>
          </div>
          ...
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-1">
              {navItems.map((item) => (
                ...
                >
                  ...
                  {pathname === item.href && (
                    <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-8 h-1 bg-sky-500 rounded-full"></div>
                  )}
                </Link>
              ))}
            </nav>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <Link href="/book-test" className="hidden lg:block">
                <Button className="bg-sky-500 hover:bg-sky-600 text-white px-6 py-2.5 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-105 flex items-center gap-2">
            ...
            <div className="container mx-auto px-4 py-4">
              ...
              <div className="mt-4 pt-4 border-t border-slate-200 space-y-3">
                <Link href="/book-test" className="block">
                  <Button className="w-full bg-sky-500 hover:bg-sky-600 text-white py-3.5 rounded-xl font-bold shadow-lg flex items-center justify-center gap-2">
