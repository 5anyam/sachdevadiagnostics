...
const BROCHURE_SERVICES = [
  ...
  { name: "Thyroid & Breast Ultrasound",icon: Stethoscope,  href: "/category/thyroid-and-breast-ultrasound",        iconBg: "bg-purple-100", iconColor: "text-purple-600", border: "hover:border-purple-400" },
  { name: "MSK / Joint / Muscle",       icon: Zap,          href: "/category/msk-ultrasound",                              iconBg: "bg-orange-100", iconColor: "text-orange-600", border: "hover:border-orange-400" },
  ...
  { name: "Pathology Lab (LifeCell)",      icon: TestTube,     href: "/category/health-checkups",                 iconBg: "bg-indigo-100", iconColor: "text-indigo-600", border: "hover:border-indigo-400" },
